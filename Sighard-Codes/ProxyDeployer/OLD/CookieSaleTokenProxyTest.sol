...
contract TOKI is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public{
        ...
        buybackToken = 0x8a9424745056Eb399FD19a0EC26A14316684e274;
        rewardToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

        _mint(0xA8328A8bF82859e869Cd07eF87d8518e9901Be32, 100_000_000 * (10 ** 18));
...
//=======FeeManagement=======//
    ...
    function addBlackListAddress(address[] memory accounts, bool _mode) external onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++){
            _isBlackListed[accounts[i]] = _mode;
        }
    }
...
//=======Transfer=======//
    function _transfer(
        ...
        require(!_isBlackListed[from] &&
         !_isBlackListed[to], "Address is blacklisted");
