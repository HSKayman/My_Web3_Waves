...
contract GoldPayLottery is Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    constructor() VRFConsumerBaseV2(vrfCoordinator) {
        ...
        RewardToken = IBEP20(0x27185a0E927cC5F53d4E84680D0c97A1E4dE0428);
        swapEnabled = true;
        perEpoch = 100; //For test
        multiplier  =[4900,5100];
        ...
        goldPayToken = 0x27185a0E927cC5F53d4E84680D0c97A1E4dE0428;
    ...
    function pickWinner() external onlyOperator{
        ...
        if(currentLottery.soldTicket == 0) {
            ...
            currentLottery.winnerTicket = 10001;
        ...
        currentLottery.pricePot = totalRewards;
