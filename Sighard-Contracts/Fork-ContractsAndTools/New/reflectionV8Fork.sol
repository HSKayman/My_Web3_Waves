...
contract ReflectionToken is Context, IERC20, Ownable {
    ...
    event WalletToWalletTransferWithoutFeeUpdated(bool enabled);
    ...
    { 
        ...
        maxWalletAmount             = _tTotal/2;

        maxTransactionLimitEnabled  = true;
        maxTransactionAmountBuy     = _tTotal/2;
        maxTransactionAmountSell    = _tTotal/2;
