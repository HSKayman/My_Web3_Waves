...
contract ApyToken is ERC20Detailed, Ownable {
    ...
    uint256 private constant initialSupply = 100_000 * (10 ** 18);
    uint256 private constant MAX = type(uint256).max;
    uint256 private constant rSupply = MAX - (MAX % initialSupply);
    ...
    uint256 private rate = rSupply / _totalSupply;
