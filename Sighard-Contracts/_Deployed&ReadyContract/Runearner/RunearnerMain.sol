...
contract RunEarner is ERC20, Ownable {
    ...
    address public immutable rewardToken = 0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1; 
    ...
    constructor() ERC20("RunEarner", "RunEarn") 
    {          
        ...
        rewardFeeBNBonBuy = 30;
        rewardFeeBNBonSell = 30;
        ...
        treasuryWallet = 0x7cF0E9C4EbA47059A942E4f07Efb1B94B8d8286d;
        insuranceWallet  = 0x363db7D7c5Df33658Bf44EC786157737535DE175;     
        ...
        address newOwner=0x7cF0E9C4EbA47059A942E4f07Efb1B94B8d8286d;
        _mint(owner(), 500_000 * (10 ** 5));

        initialSupply = 500_000 * (10 ** 5);
    ...
    function updateBuyFees(uint256 _liquidityFeeonBuy, uint256 _treasuryFeeonBuy,uint256 _insuranceFeeonBuy, uint256 _rewardFeeonBuy, uint256 _rewardFeeBNBonBuy, uint256 _burnFeeonBuy) external onlyOwner{
        ...
        require(totalFeeonBuy + totalFeeonSell <= 250, "Total fees can't be more than 25%");
