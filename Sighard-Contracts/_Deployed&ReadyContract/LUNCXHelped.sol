...
contract LunaProtocol is ERC20, Ownable {
    ...
    address public immutable rewardToken = 0x8a9424745056Eb399FD19a0EC26A14316684e274; //Testnet   ----  Mainnet luna classic : 0x...
    ...
    constructor() ERC20("Luna Protocol", "$LUNAP") 
    {   
        liquidityBuyFee = 3;
        treasuryBuyFee = 4;
        ecosystemBuyFee = 4;
        ...
        treasuryWallet = 0xfee1eDA9075244bdD34cf54516F04AE5803a4eC8;
        ecosystemWallet  = 0xfee2879FAAb37E5662BD5E9D2f211cFc897C7340;     
        rewardPoolWallet = 0xfee3d95BABd86Ca3a071233449F9A4ac32592cBC;

        walletToWalletTransferWithoutFee = true;
        dividendTracker = new DividendTracker(40000, rewardToken);//Think  minimum amount for dividend
        ...
        initialSupply = 4_000_000_000 * (10 ** 18); // total supply of Luna Protocol
    ...
    function _transferFrom(
        ...
        uint256 amountReceived = (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient] || wtwWoFee) ? rAmount : takeFee(sender, rAmount, (recipient == uniswapV2Pair));
