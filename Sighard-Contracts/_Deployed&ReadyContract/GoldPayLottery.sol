...
contract GoldPayLottery is Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    constructor() VRFConsumerBaseV2(vrfCoordinator) {
        ...
        marketingWallet = 0xF8280F7A5cc1A58C2dbb5F23d7160ae79d6dEeab;
        goldPayToken = 0xe7517065Dba27590E5bE8192fBc8565D387fc77d;
    ...
    function changeLunanasToken(address _goldPayToken) external onlyOwner {
        require(_goldPayToken != address(goldPayToken), "GoldPayToken token is already that address");
        require(_goldPayToken != address(0), "GoldPayToken token is the zero address");
