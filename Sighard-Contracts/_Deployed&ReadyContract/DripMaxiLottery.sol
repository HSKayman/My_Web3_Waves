...
contract DripMaxiLottery is Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    event DripMaxiTokenChanged(address _dripMaxiToken);
    ...
    constructor() VRFConsumerBaseV2(vrfCoordinator) {
        ...
        marketingWallet = 0x3Ca8693CfccE2555535475ac86DC2e3721BE547f;
        dripMaxiToken = 0x431e58BE5C935B38b392F43859A94b549C57A496;
    ...
    function changeDripMaxiToken(address _dripMaxiToken) external onlyOwner {
        require(_dripMaxiToken != address(dripMaxiToken), "DripMaxi token is already that address");
        require(_dripMaxiToken != address(0), "DripMaxi token is the zero address");
        dripMaxiToken = address(_dripMaxiToken);
        emit DripMaxiTokenChanged(_dripMaxiToken);
    }
