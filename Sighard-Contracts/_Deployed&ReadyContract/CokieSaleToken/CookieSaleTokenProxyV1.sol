...
contract DividendTracker is OwnableUpgradeable, DividendPayingToken {
    ...
    function initialize() external initializer {
        DividendPayingToken.__DividendPayingToken_init(address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7),"DIVIDEND_TRACKER","DIVIDEND_TRACKER");//Testnet
        claimWait = 3600;
...
contract COOKIE is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public{
        ...
        kodiToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;//Testnet
        rewardToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;//Testnet
