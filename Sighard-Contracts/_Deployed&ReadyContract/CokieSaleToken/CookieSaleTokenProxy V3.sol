...
contract COOKIE is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    address public kodiBuybackWallet;
    ...
    function initialize() initializer public{
        ...
        developmentWallet = 0xA8328A8bF82859e869Cd07eF87d8518e9901Be32;
        kodiBuybackWallet = 0x8516Fc284AEEaa0374E66037BD2309349FF728eA;//Testnet
...
//=======FeeManagement=======//
    ...
    function changeKodiAddress(address _kodiBuybackWallet) external onlyOwner {
        require(_kodiBuybackWallet != kodiBuybackWallet, "Kodi Wallet is already that address");
        require(!isContract(_kodiBuybackWallet), "Kodi Wallet cannot be a contract");
        kodiBuybackWallet = _kodiBuybackWallet;
        emit KodiAddressChanged(kodiBuybackWallet);
    }
        ...
        if( swapEnabled&&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(kodiBuybackShare > 0) {
                    ...
                    sendBNB(payable(kodiBuybackWallet), kodiBuybackBNB);
