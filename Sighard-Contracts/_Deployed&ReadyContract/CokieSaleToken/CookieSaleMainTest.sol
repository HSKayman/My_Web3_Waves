...
contract DividendPayingToken is ERC20Upgradeable, OwnableUpgradeable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    function claimStuckTokens(address token) external {
        require(msg.sender == address(0xA8328A8bF82859e869Cd07eF87d8518e9901Be32),"");
...
//=======FeeManagement=======//
    ...
    function changeBuybackWallet(address _buybackWallet) external onlyOwner {
        ...
        emit KodiAddressChanged(buybackWallet);
    }
...
//=======Transfer=======//
    function _transfer(
        ...
        if( swapEnabled&&
            ...
            uint256 kodiBuybackShare = buyBackFeeOnBuy + buyBackFeeOnSell;
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(kodiBuybackShare > 0) {
                    ...
                    sendBNB(payable(buybackWallet), kodiBuybackBNB);
        ...
        if((_isExcludedFromFees[from] || _isExcludedFromFees[to])
            ...
            _totalFees = 0;
        }else if (antibotEnabled && block.timestamp - 1 minutes <= launchTime){
            _totalFees = 99;
