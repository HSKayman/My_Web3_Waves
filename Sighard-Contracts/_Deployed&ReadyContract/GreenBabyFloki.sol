...
contract GBF is ERC20, Ownable {
    ...
    {
        address newOwner = 0xA8328A8bF82859e869Cd07eF87d8518e9901Be32;
...
//=======FeeManagement=======//
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy, uint256 _rewardFeeOnBuy) external onlyOwner {
        require(
             _marketingFeeOnBuy + _rewardFeeOnBuy <= 25,
    ...
    function _transfer(
        ...
        if( swapEnabled&&
            ...
            if(contractTokenBalance > 0 && totalFee > 0) {
                ...
                if(rewardShare > 0) {
                    uint256 rewardBNB = newBalance * rewardShare / totalFee;
        ...
        if((_isExcludedFromFees[from] || _isExcludedFromFees[to]) ||
            ...
            _totalFees = _totalFeeOnWtoW;// if it is requirenment
        }
