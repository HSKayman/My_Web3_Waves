...
contract PoodleToken is Context, IERC20, Ownable {
    ...
    string private _name     = "Poodle Token";
    ...
    address public marketingWallet = 0xe7040C653efeaBc2744C0EE825e2604Bf8B5B1Ae;
    address public devTeamWallet = 0xaDd61DcB4BB8beA5d6D6e9f521BAa0384b30f594;
    ...
    constructor() 
    { 
        address newOwner = 0x7F17cde5244672cb492F5ADb868b2Ecf697faacA;
    ...
    function _takeBurn(address sender, uint256 tTransferAmount, uint256 rTransferAmount, uint256 tAmount) private returns (uint256, uint256) {
        ...
        if(_isExcluded[DEAD])
            _tOwned[DEAD] = _tOwned[DEAD] + tMarketing;
