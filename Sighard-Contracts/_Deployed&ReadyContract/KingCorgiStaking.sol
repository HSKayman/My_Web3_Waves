...
contract KingCorgiStaking is Ownable, ReentrancyGuard {
    ...
    constructor() {
        token = IERC20(0x184aF67D26d7DB08F5dAaB8A43315D25f76819C7);
        //poolInfo.push(PoolInfo(500,0,7 days,0,0,2500,true));//7
        //poolInfo.push(PoolInfo(2500,0,30 days,0,0,2500,true));//30
        //poolInfo.push(PoolInfo(6000,0,60 days,0,0,2500,true));//60
        //poolInfo.push(PoolInfo(11000,0,90 days,0,0,2500,true));//90
