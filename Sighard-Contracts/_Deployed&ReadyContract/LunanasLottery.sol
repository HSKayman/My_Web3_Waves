...
contract LunanasLottery is Ownable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    event LunanasTokenChanged(address _lunanasToken);
    ...
    constructor() VRFConsumerBaseV2(vrfCoordinator) {
        ...
        lunanasToken = 0x4E32f7eF3e364F02D762CE8519aB43273907bb2F;
    ...
    function changeLunanasToken(address _lunanasToken) external onlyOwner {
        require(_lunanasToken != address(lunanasToken), "LunanasToken token is already that address");
        require(_lunanasToken != address(0), "LunanasToken token is the zero address");
        lunanasToken = address(_lunanasToken);
        emit LunanasTokenChanged(_lunanasToken);
    }
