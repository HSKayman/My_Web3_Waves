...
contract ArtexStaking is Ownable, ReentrancyGuard {
    ...
    constructor() {
        token = IERC20(0x8Af33e39214c3CE3c367ccc923Ee74b49CD4bC05);
        poolInfo.push(PoolInfo(1400,0,5184000,0,0,2500,false));//60
        poolInfo.push(PoolInfo(2500,0,7776000,0,0,2500,true));//90
        poolInfo.push(PoolInfo(3700,0,10368000,0,0,2500,true));//120
        poolInfo.push(PoolInfo(18000,0,31536000,0,0,2500,true));//365
    }
