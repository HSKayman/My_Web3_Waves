...
contract ArtexStaking is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    constructor() {
        token = IERC20Upgradeable(0x9EE24b8d9FBd75EFC2E0eCBc5e53160716637d02);
    }
