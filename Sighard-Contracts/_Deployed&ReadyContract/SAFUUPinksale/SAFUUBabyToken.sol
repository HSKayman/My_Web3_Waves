...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount > totalSupply() / 100000, "SwapTokensAtAmount must be greater than 0.001% of total supply");
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner {
        ...
        require(
            wallet != _marketingWalletAddress,
            "BABYTOKEN: The marketing wallet cannot be the same"
        );
