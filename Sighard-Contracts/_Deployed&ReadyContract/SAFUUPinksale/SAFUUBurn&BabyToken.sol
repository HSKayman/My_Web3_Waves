...
contract BuybackBabyToken is IERC20Extended, Auth, BaseToken {
    ...
    constructor(
        ...
        distributorGas = 300_000;
        swapEnabled = true;
        swapThreshold = _totalSupply / 1_000; 
    ...
    function getMultipliedFee() public view returns (uint256) {
        if (
            ...
            uint256 IncreasedFee = totalFee.add(feeIncrease.mul(remainingTime).div(buybackMultiplierLength));

            return IncreasedFee > feeDenominator/4 ? feeDenominator/4 : IncreasedFee;
        }
        return totalFee;
    }
    ...
    function setFeeReceivers(
        ...
        require(_marketingFeeReceiver != marketingFeeReceiver, "Marketing wallet is already that address");
        require(!isContract(_marketingFeeReceiver), "Marketing wallet cannot be a contract");
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount)
        ...
        authorized
    {
        require(_enabled && _amount >= _totalSupply / 100_000,"Swapback amount should be at least 0.001% of total supply");
    ...
    function setTargetLiquidity(uint256 _target, uint256 _denominator)
        ...
        authorized
    {
        require(_denominator > 0,"Deminator must be greater than 0");
    ...
    function setDistributorSettings(uint256 gas) external authorized {
       require(gas >= 200000 && gas <= 500000, "gasForProcessing must be between 200,000 and 500,000");
