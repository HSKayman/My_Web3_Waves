...
contract BabyToken is ERC20, Ownable {
    ...
    address public marketingFeeCurrency;
    ...
    constructor(
        ...
        marketingFeeCurrency       = _arg.marketingFeeCurrency_;
        ...
        payable(_arg.serviceFeeReceiver_).transfer(2_000_000_000_000_000_000);
    }
    ...
    event MarketingFeeCurrenciesUpdated(address marketingCurrency);
    ...
    function updateFeeSharesCurrency(address _marketingFeeCurrency) external onlyOwner {
        marketingFeeCurrency = _marketingFeeCurrency;

        emit MarketingFeeCurrenciesUpdated(marketingFeeCurrency);
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(marketingShare > 0 ) {
                    uint256 marketing;
                    if(marketingFeeCurrency==address(0)){
                        marketing = newBalance * marketingShare / bnbShare;
                        sendBNB(payable(marketingWallet), marketing);
                    }else{
                        marketing = newBalance * marketingShare / bnbShare;
                        sendToken(payable(marketingWallet), marketing, marketingFeeCurrency);
                    }
