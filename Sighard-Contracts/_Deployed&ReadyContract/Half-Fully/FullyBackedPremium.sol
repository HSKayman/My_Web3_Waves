...
contract BabyToken is ERC20, Ownable {
    ...
    constructor(ConstructorArgument memory _arg) payable ERC20(_arg.name_, _arg.symbol_) {
        ...
        require(salaryFeeAvailable || _arg.feeManager_.salaryShare_ == 0,"Salary Fee isn't available");
        require(stakingFeeAvailable || _arg.feeManager_.stakingShare_ == 0,"Staking Fee isn't available");
